use crate::cap::{CapSet, Capability};
...
impl Task {
    pub fn new(id: usize, name: String) -> Self {
        Self {
            ...
            msg_queue: MessageQueue::new(10), // default size
        }
    }
...
pub struct TaskManager {
    next_id: usize,
    pub tasks: Vec<Task>, // made public for access in main
}
